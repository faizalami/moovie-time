  ...
  <nav class="bg-white/[0.05] text-sm fixed w-full z-50">
    ...
    <div id="mobile-menu" class="md:hidden">
      <Combobox v-model="selectedMovie">
        <div class="relative mt-1 text-neutral-200 px-4 md:px-0">
          <div
            class="relative h-8 w-96 max-w-full cursor-default overflow-hidden rounded-lg text-left shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-teal-300 sm:text-sm"
          >
            <ComboboxInput
              class="w-full bg-black/[0.13] border-none py-2 pl-8 pr-10 text-sm leading-5 text-gray-900 focus:ring-0 focus:ring-offset-0 outline-none"
              :display-value="(movie) => (movie as MovieKeywords).name"
      ...
      <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3 text-neutral-200 flex items-center">
        <Menu as="div" class="relative inline-block text-left">
          ...
          >
            <MenuItems
              class="absolute left-0 md:left-auto md:right-0 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
            >
              <div class="px-1 py-1">
                <MenuItem>
                  <button class="group flex w-full text-secondary items-center rounded-md px-2 py-2 text-sm">
        ...
        <NuxtLink v-slot="{ href, target }" to="/movies" custom>
          <a :href="href" :target="target" class="rounded-md px-3 py-2 m-0 font-medium">MOVIES</a>
        </NuxtLink>

        <NuxtLink v-slot="{ href, target }" to="/tv-shows" custom>
          <a :href="href" :target="target" class="rounded-md px-3 py-2 m-0 font-medium">TV SHOWS</a>
        </NuxtLink>

        <a href="#" class="rounded-md px-3 py-2 m-0 font-medium">LOGIN</a>
      </div>
    </div>
  </nav>
</template>
